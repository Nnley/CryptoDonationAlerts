	...
	return (
		<div className={cn('relative')}>
			...
			<input
				type={type}
				className={cn(
					'flex h-12 w-full rounded-[10px] border-input bg-[#323232] px-4 py-1 text-base text-[rgba(217, 217, 217, 1)] shadow-sm transition-colors placeholder:text-[#858585] placeholder:text-base',
